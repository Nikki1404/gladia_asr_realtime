...
getting this 
nikita_verma2@cx-asr-test:~/nemotron_asr$ docker build -t nemotron_3.5_asr .
Sending build context to Docker daemon  146.4kB
Error response from daemon: dockerfile parse error line 66: unknown instruction: IMPORT
