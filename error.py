...
(nemo_env) root@cx-asr-test:/home/nikita_verma2/nemotron_asr# nohup python3 -u benchmark_maria_nemotron.py --only-file maria18 --no-download --realtime --segment-seconds 300 --receive-timeout 1200 --force --force-wav --force-split > nemotron_maria18.log 2>&1 &
[1] 553243
(nemo_env) root@cx-asr-test:/home/nikita_verma2/nemotron_asr# tail -f nemotron_maria18.log 
[info] Running only file: maria18

Found 1 maria audio files to run.

================================================================================
[1/1] Benchmarking: maria18.mp3
================================================================================
Reference: maria18_reference.txt
[warn] Removing incomplete/old WAV: benchmark_workspace/wav_16k/maria18.wav
[cmd] ffmpeg -nostdin -y -hide_banner -loglevel warning -stats -i benchmark_workspace/audios/maria18.mp3 -vn -map 0:a:0 -ac 1 -ar 16000 -sample_fmt s16 benchmark_workspace/wav_16k/maria18.wav
[mp3 @ 0x5585ef68f940] Estimating duration from bitrate, this may be inaccurate
size=       1kB time=00:00:00.02 bitrate= 280.8kbits/s speed=N/A    
size=    8448kB time=00:04:33.08 bitrate= 253.4kbits/s speed= 546x    
size=   17408kB time=00:09:17.08 bitrate= 256.0kbits/s speed= 557x    
size=   27648kB time=00:14:47.35 bitrate= 255.2kbits/s speed= 592x    
size=   36352kB time=00:19:27.72 bitrate= 255.0kbits/s speed= 584x    
size=   44800kB time=00:24:01.30 bitrate= 254.6kbits/s speed= 576x    
size=   53248kB time=00:28:26.13 bitrate= 255.7kbits/s speed= 569x    
size=   61696kB time=00:32:59.55 bitrate= 255.3kbits/s speed= 566x    
size=   70400kB time=00:37:35.30 bitrate= 255.7kbits/s speed= 564x    
size=   79104kB time=00:42:11.44 bitrate= 256.0kbits/s speed= 563x    
size=   87552kB time=00:46:47.35 bitrate= 255.5kbits/s speed= 561x    
size=   96256kB time=00:51:23.59 bitrate= 255.7kbits/s speed= 561x    
size=  104960kB time=00:56:00.41 bitrate= 255.9kbits/s speed= 560x    
size=  113664kB time=01:00:37.34 bitrate= 256.0kbits/s speed= 560x    
size=  122112kB time=01:05:14.10 bitrate= 255.6kbits/s speed= 559x    
size=  130816kB time=01:09:50.24 bitrate= 255.7kbits/s speed= 559x    
size=  139520kB time=01:14:25.71 bitrate= 255.9kbits/s speed= 558x    
size=  147968kB time=01:19:02.05 bitrate= 255.6kbits/s speed= 558x    
size=  156672kB time=01:23:36.99 bitrate= 255.8kbits/s speed= 557x    
size=  165376kB time=01:28:13.03 bitrate= 256.0kbits/s speed= 557x    
size=  173824kB time=01:32:50.50 bitrate= 255.6kbits/s speed= 557x    
size=  182528kB time=01:37:25.88 bitrate= 255.8kbits/s speed= 557x    
size=  185004kB time=01:38:40.13 bitrate= 256.0kbits/s speed= 557x    

[info] Full WAV complete: benchmark_workspace/wav_16k/maria18.wav duration=5920.13s
[cmd] ffmpeg -nostdin -y -hide_banner -loglevel warning -stats -i benchmark_workspace/wav_16k/maria18.wav -f segment -segment_time 300 -reset_timestamps 1 -c copy benchmark_workspace/segments_16k/maria18/maria18_part_%04d.wav
Guessed Channel Layout for Input Stream #0.0 : mono
size=N/A time=00:00:00.12 bitrate=N/A speed=N/A    
size=N/A time=01:38:40.13 bitrate=N/A speed=1.45e+04x    

[info] Segmenting complete for maria18.wav: 20 segments
Created/found 20 segments for maria18.mp3

Transcribing segment 1/20: maria18_part_0000.wav
Sending segment 1/20 duration=300.03s chunks=3001 realtime=True
[error] Failed benchmarking maria18.mp3: received 1011 (internal error) keepalive ping timeout; then sent 1011 (internal error) keepalive ping timeout
Saved error file: benchmark_workspace/results/nemotron_3.5/maria18_error.json
[cmd] gcloud storage cp benchmark_workspace/results/nemotron_3.5/maria18_error.json gs://cx-asr-test-data/results/nemotron_3.5/
Copying file://benchmark_workspace/results/nemotron_3.5/maria18_error.json to gs://cx-asr-test-data/results/nemotron_3.5/maria18_error.json
